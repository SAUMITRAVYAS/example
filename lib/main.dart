...
void initState(){
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("ELECTA",textDirection: TextDirection.ltr,),
        actions: <Widget>[
          IconButton(
      ...
      Padding(padding: EdgeInsets.only(top: 120.0,left: 16.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text("Saumitra Vyas", style: TextStyle(
        fontWeight: FontWeight.bold,
        fontSize: 16.0,
        color: Colors.white)),
          Text("a responsible Voter",textDirection: TextDirection.ltr, style: TextStyle(color: Colors.white)),
        ],
      ),
    ),
          ],
